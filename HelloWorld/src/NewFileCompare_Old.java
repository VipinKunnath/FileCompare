...
public class NewFileCompare_Old {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					NewFileCompare_Old window = new NewFileCompare_Old();
	...
	private void initialize() {
		...
		btnCompare.addActionListener(new ActionListener() {
			...
			private void createDifferenceFile(ExcelDataManager newFileExcel) throws IOException {
				...
				try {
					diffFileExcel.setCompleteFilePath(diffFilePath+"\\DiffFile.xlsx");
					diffFile=new FileOutputStream(diffFilePath+"\\DiffFile.xlsx");
